...
/**
 * @brief initialise a list of key-value pair content (both of them)
 * @return an initialised list of pair
 */
kv_list_t *kv_list_init();

/**
 * @brief add a key-value pair to a list if pair (both of them)
 * @param kv the key-value pair to free
 */
